...
import com.diditra.vpn_client.databinding.ItemQrcodeBinding
import com.diditra.vpn_client.databinding.ItemRecyclerFooterBinding
import com.diditra.vpn_client.databinding.ItemRecyclerMainBinding
...
import com.diditra.vpn_client.helper.ItemTouchHelperAdapter
import com.diditra.vpn_client.helper.ItemTouchHelperViewHolder
...
//            }
            ...
            val splitIp: List<String> = outbound?.getServerAddress().toString().split(".")
            if (splitIp.size > 0) {
                holder.itemMainBinding.tvStatistics.text = "DD Server " + splitIp.last()
            } else {
                holder.itemMainBinding.tvStatistics.text = "DD Server"
            }
